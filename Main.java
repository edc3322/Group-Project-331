...
public static Sale addSale()
{
    ...
    Scanner scan = new Scanner(System.in);
    System.out.println("Item ID: " + newSale.getSaleID());
    //int itemID = scan.nextInt();

    System.out.print("Item Name: ");
    String itemName = scan.nextLine();
   // newSale.setItemName(scan.nextLine());  

    System.out.print("Selling Price: ");
    //double sellingPrice = scan.nextDouble();
    newSale.setSellingPrice(scan.nextDouble()); 

    System.out.print("Quantity: ");
   // int quantity = scan.nextInt();
    newSale.setQuantity(scan.nextInt());

    System.out.print("Customer name: ");
  //  String customer = scan.nextLine();
    newSale.setCustomer(scan.nextLine());

    System.out.print("Date of Sale: ");
   // String date = scan.nextLine();
    newSale.setDate(scan.nextLine());
